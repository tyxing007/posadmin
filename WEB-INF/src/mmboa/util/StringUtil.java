...
public class StringUtil {
	...
	public static String formatDate(String s) {
		...
		date.append(dateStr[0]).append("-")
				.append(String.format("%02d", Integer.parseInt(dateStr[1])))
				.append("-")
				.append(String.format("%02d", Integer.parseInt(dateStr[2])));
	 ...
	 * @return
	 */
	public static String formatDate2(String s) {
		String dateStr[] = s.split("-");
		StringBuffer date = new StringBuffer();
		date.append(dateStr[0]).append("-")
				.append(String.format("%02d", Integer.parseInt(dateStr[1])));
